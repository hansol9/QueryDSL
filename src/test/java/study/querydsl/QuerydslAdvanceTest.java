...
//    }
    ...
    //광고상태 isAvailable, 날짜가 IN: isServiceable
    /*private BooleanExpression isServiceable(String usernameParam, Integer ageParam) {
        return isValid(usernameParam).and(DateBetweenIn(ageParam));
    }
    */
